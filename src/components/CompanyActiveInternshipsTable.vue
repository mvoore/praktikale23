<template>
  <DeactivateInternshipModal ref="deactivateInternshipModalRef"></DeactivateInternshipModal>
  <table class="table table-dark table-hover">
    ...
    <tr v-for="internship in companyActiveInternships" :key="internship.internshipId">
      ...
      <td><font-awesome-icon @click ="openDeactivateInternshipModal(internship.internshipId)" class="hoverable-icon" :icon="['fas', 'trash-can']" /></td>
    </tr>
    </tbody>
  </table>
</template>
